...
```{r}
gene_alignment <- "~/Desktop/BIOL8706/phylogenetic_project/Phylogenetic_project/Data/mixture_class_single_gene/EOG09150A0E.fna.aln"
file_name <- basename(gene_alignment)
gene_name <- sub("^(.*?)\\.fna\\.aln$", "\\1", file_name)
```

```{r}
# Read the tree 

file_path <- list.files("Data/one_class_single_gene", pattern = "^Single.*\\.iqtree$", full.names = TRUE)
...
Mixture_tree = read.tree("Data/mixture_class_single_gene/mix_class_EOG09150A0E.treefile")
One_class_tree = read.tree("Data/one_class_single_gene/one_class_EOG09150A0E.treefile")
Species_tree = read.tree("~/Desktop/BIOL8706/phylogenetic_project/drosophila_introgression_data/tree/astral.tre")
```
